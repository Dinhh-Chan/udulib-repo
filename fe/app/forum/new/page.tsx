    ...
    <div className="container py-8 px-4 md:px-6">
      <div className="flex flex-col gap-8 max-w-3xl mx-auto">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground">Chia sẻ câu hỏi, kiến thức hoặc tài nguyên với cộng đồng</p>
        </div>

        {isSuccess ? (
          <Card>
            <CardHeader>
              <CardTitle>Đăng bài thành công!</CardTitle>
              <CardDescription>Bài viết của bạn đã được đăng thành công.</CardDescription>
            </CardHeader>
            <CardContent>
              <Alert className="bg-green-50 dark:bg-green-950 border-green-200 dark:border-green-800">
                <AlertCircle className="h-4 w-4 text-green-600 dark:text-green-400" />
                <AlertTitle>Bài viết đã được đăng</AlertTitle>
                <AlertDescription>
                  Bài viết của bạn đã được đăng thành công và hiện đã có trên diễn đàn. Cảm ơn bạn đã đóng góp!
                </AlertDescription>
              </Alert>
            </CardContent>
            <CardFooter className="flex gap-2">
              ...
              <Button asChild>
                <Link href="/forum/new">Tạo bài viết khác</Link>
              </Button>
            </CardFooter>
          </Card>
        ) : (
          <form onSubmit={handleSubmit}>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Vui lòng điền đầy đủ thông tin cho bài viết của bạn</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Hỗ trợ định dạng Markdown. Bạn có thể sử dụng **in đậm**, *in nghiêng*, và `code`.
                  </p>
                </div>
